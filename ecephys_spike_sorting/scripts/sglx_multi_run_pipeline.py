...
software_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))

# Raw data directory = npx_directory
# run_specs = name, gate, trigger and probes to process
npx_directory = os.path.join(software_dir, 'test_input')
...
run_specs = [									
						['Pit_RecordingPost_ProbeTest_07012026', '0', '0,0', '0', '', ['default'] ]
]
...
catGT_dest = os.path.join(software_dir, 'test_output')
...
ks_copy_fproc = 0   # used by 2.5, 3, 4, to save drift corrected binary
...
ks_nblocks = 1      # for KS2.5 KS3, and KS4; 1 for rigid registration in drift correction,
